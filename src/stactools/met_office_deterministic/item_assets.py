"""Vendored from pystac v1.12 to support pystac v1.10, which is used by the
...
class ItemAssetDefinition:
    ...
    def __init__(
        self, properties: dict[str, Any], owner: Collection | None = None
    ) -> None:
    ...
    def set_owner(self, obj: Collection) -> None:
